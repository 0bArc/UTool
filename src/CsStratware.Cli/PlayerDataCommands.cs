...

{
...

    {
        ...
        Console.WriteLine("""
            ...
            playerdata commands:
              ...
              csmanager playerdata list [--root <dir>] [--game <gameId>]

              csmanager playerdata status <mod-dir> [--root <dir>] [--game <gameId>]

              csmanager playerdata prepare <mod-dir> [--root <dir>] [--game <gameId>] [--force-extract]

              csmanager playerdata apply <mod-dir> [--profile <steamId>] [--dry-run] [--root <dir>] [--game <gameId>]
    ...
    private static string ResolveRoot(string[] args, StratwareConfig? cfg, ModPackage? package, string? gameId = null)

    {
        ...
        throw new InvalidOperationException("Pass --root, --game, or set playerDataDir in csstratware.json.");
